...
static unsigned int barh       = 24;        /* bar height in px, HTRAY_HEIGHT */
...
static unsigned int fontsize   = 13;        /* px size appended to the pattern; 0 = pattern's own, HTRAY_FONTSIZE */
